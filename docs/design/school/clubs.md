...
- **Participation:**  
  Player may join **1 club per year** (can switch between years).

- **Schedule:**
    - Club Hour happens 3x/week (e.g. Mon, Wed, Fri afternoons)
    - Optional attendance: player chooses whether to attend
    - Missing clubs may affect relationship gain or stat progress

- **Benefits:**
    - Passive stat bonuses (e.g. Intelligence, Mood, Energy, etc.)
    - Unlocks unique club-related NPCs and storylines
    - Some events are **exclusive** to club members

- **Club Rank:**
    - Player may earn club points through participation
    - High points unlock special titles, recognition at end of year

- **Leaving or Switching Clubs:**
    - Permitted only during early months (e.g. until October)
    - May incur social penalty (e.g. lose relationship progress)
...
- **Featured NPCs:** Reserved, imaginative types
...
- **Featured NPCs:** Competitive, active, team-oriented
...
- **Featured NPCs:** Thoughtful, quiet, introspective types
...
- **Featured NPCs:** Analytical, socially awkward, nerdy types
...
- **Featured NPCs:** Expressive, artistic, emotional characters
...
- **Featured NPCs:** Charismatic, confident, dramatic types
...
- **Featured NPCs:** Methodical, curious, detail-oriented
...
- **Featured NPCs:** Gentle, patient, nature-loving types
...
- **Featured NPCs:** Calm, balanced, often spiritual
